...
const Detail = (merchandise: Merchandise) => {
    ...
    maxNumberOfPurchasesP.innerHTML = `Max purchases: ${merchandise.maxNumberOfPurchases !== -1 ? merchandise.maxNumberOfPurchases : "∞"}`;
    ...
    goBackButton.classList.add("btn", "btn-outline-primary", "bg-white", "px-5", "hover");
